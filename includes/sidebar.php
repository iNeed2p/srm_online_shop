...
<img src='other_images/$manufacturer_image' width='20px' >&nbsp;
  ...
  <div class="panel-collapse collapse-data">
    ...
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-p-cats"
...
$p_cat_image = "<img src='other_images/$p_cat_image' width='20'> &nbsp;";
  ...
  <div class="panel-collapse collapse-data">
    ...
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-cats"
...
$cat_image = "<img src='other_images/$cat_image' width='20'>&nbsp;";
